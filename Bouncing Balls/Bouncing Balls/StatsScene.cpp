...
void StatsScene::init() {
	...
	text.push_back(new sf::Text(std::string("Campaign Complete: " + Utils::boolToString(Player::getData()->campaign_finished)), *AssetManager::getFont("title"), 34));
	...
	text.push_back(new sf::Text(std::string("Total Campaign Stars (/Max): " + std::to_string(total_stars) + " / 18"), *AssetManager::getFont("title"), 34));
	...
	text.push_back(new sf::Text(std::string("High-score (Endless Mode): " + std::to_string(Player::getData()->endless_hs)), *AssetManager::getFont("title"), 34));
	...
	text.push_back(new sf::Text(std::string("High-score (Challenge Mode): " + std::to_string(Player::getData()->challenge_hs)), *AssetManager::getFont("title"), 34));
	...
	//Display total coins
	text.push_back(new sf::Text(std::string("Total Coins: " + std::to_string(Player::getData()->coins)), *AssetManager::getFont("title"), 34));
