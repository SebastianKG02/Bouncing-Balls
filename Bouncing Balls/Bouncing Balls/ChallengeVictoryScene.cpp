...
ChallengeVictoryScene::ChallengeVictoryScene(int id, std::string name) {
	this->sceneID = id;
	this->name = name;
}

void ChallengeVictoryScene::init() {
	...
	text.push_back(new sf::Text(std::string("Back to Challenge"), *AssetManager::getFont("title"), 30));
	...
	//Victory indicator
	text.push_back(new sf::Text(std::string("VICTORY!"), *AssetManager::getFont("title"), 150));
	...
	//Level notifier
	text.push_back(new sf::Text(std::string("Challenge Level " + std::to_string(Player::getData()->challenge_level - 1) + " Complete!"), *AssetManager::getFont("title"), 56));
	...
	sprites.push_back(new sf::Sprite(*AssetManager::getTexture(std::to_string(Player::getData()->challenge_last_stars) + "_stars")));
...
void ChallengeVictoryScene::update(sf::RenderWindow* w) {
...
void ChallengeVictoryScene::input(sf::Event* e) {
