...
ChallengeInfoScene::ChallengeInfoScene(int id, std::string name) {
	this->sceneID = id;
	this->name = name;
}

void ChallengeInfoScene::init() {
	...
	//Title text
	text.push_back(new sf::Text(std::string("Challenge"), *AssetManager::getFont("title"), 75));
	//Set real position
	...
	text.push_back(new sf::Text(std::string("Endless with modifiers not hard enough?"), *AssetManager::getFont("title"), 34));
	...
	text.push_back(new sf::Text(std::string("Challenge mode generates random levels,"), *AssetManager::getFont("title"), 34));
	...
	text.push_back(new sf::Text(std::string("which progressively get harder in many ways."), *AssetManager::getFont("title"), 34));
...
void ChallengeInfoScene::update(sf::RenderWindow* w) {
...
void ChallengeInfoScene::input(sf::Event* e) {
